...
func TopNav() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<div><nav class=\"fixed top-0 right-0 left-0 z-50 h-16 bg-white border-b border-gray-200 shadow-sm\"><div class=\"flex items-center justify-between h-full px-4\"><div class=\"flex items-center space-x-4\"><button id=\"toggle-sidebar\" class=\"p-2 rounded-lg hover:bg-gray-100\"><i data-lucide=\"menu\" class=\"w-6 h-6\"></i></button><h1 class=\"text-xl font-semibold text-gray-800\">Mi Dashboard</h1></div><div class=\"flex items-center space-x-4\"><a href=\"/dashboard\" hx-get=\"/dashboard\" hx-target=\"#sidebar\" hx-swap=\"innerHTML\" class=\"flex items-center p-2 rounded-lg hover:bg-gray-100\"><i data-lucide=\"file-text\" class=\"w-5 h-5 mr-2\"></i> <span>Dashboard</span></a> <a href=\"/comparativas\" hx-get=\"/comparativas\" hx-target=\"#sidebar\" hx-swap=\"innerHTML\" class=\"flex items-center p-2 rounded-lg hover:bg-gray-100\"><i data-lucide=\"file-text\" class=\"w-5 h-5 mr-2\"></i> <span>Comparativas</span></a> <a href=\"/reportes\" hx-get=\"/reportes\" hx-target=\"#sidebar\" hx-swap=\"innerHTML\" class=\"flex items-center p-2 rounded-lg hover:bg-gray-100\"><i data-lucide=\"file-text\" class=\"w-5 h-5 mr-2\"></i> <span>Reportes</span></a> <a href=\"/georeferencia\" hx-get=\"/georeferencia\" hx-target=\"#sidebar\" hx-swap=\"innerHTML\" class=\"flex items-center p-2 rounded-lg hover:bg-gray-100\"><i data-lucide=\"map\" class=\"w-5 h-5 mr-2\"></i> <span>Georeferencia</span></a><div class=\"flex items-center space-x-3\"><span class=\"text-sm font-medium text-gray-700\">John Doe</span> <button class=\"p-2 rounded-full hover:bg-gray-100\"><i data-lucide=\"user\" class=\"w-6 h-6\"></i></button></div></div></div></nav></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
